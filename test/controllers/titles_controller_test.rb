...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { country: @title.country, description: @title.description, genre: @title.genre, published_at: @title.published_at, year: @title.year } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { country: @title.country, description: @title.description, genre: @title.genre, published_at: @title.published_at, year: @title.year } }
